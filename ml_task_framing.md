# Machine Learning Task Framing: Freestyle Lane (Semantic Intent Mapping)

## 1. Machine Learning Task Type
This problem is formulated as a two-stage unsupervised and scoring task:
*   **Stage 1 (Unsupervised Clustering):** Grouping 384-dimensional query vector embeddings to discover latent user intent categories without manual labeling.
